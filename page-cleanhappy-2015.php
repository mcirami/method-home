					...
					<div class="video_info">
						<div class="video_info_top">
							<div class="video_info_text">
								<h3><?php the_sub_field('video_episode'); ?></h3>
								<h2><?php the_sub_field('video_title'); ?></h2>
							</div>
						</div>
						<div class="video_info_bottom">
							...
							<?php if(get_sub_field('button_text')) { ?>
								<?php echo do_shortcode('[bgButtonNewWin size="small" color="'.$color.'" align="left" link="'.get_sub_field('button_url').'"]'.get_sub_field('button_text').'[/bgButtonNewWin]'); ?>
							<?php } ?>
